...
*** *************************;
IF _DM_BAD EQ 0 THEN DO;
   H11  =     1.31119830202743 * S_Age  +    -0.85473317278251 * S_X2
          +     0.39214796565715 * S_X4  +     0.61349439215446 * S_X5 ;
   H11  = H11  +     2.05589157809788 * Incomehigh  +     4.38806495936846 * 
        ResidenceCHI  +    -0.26422130812874 * ResidenceLA ;
   H11  =     1.16869437616871 + H11 ;
   H11  = TANH(H11 );
END;
ELSE DO;
   H11  = .;
...
IF _DM_BAD EQ 0 THEN DO;
   P_WidgBuyYes  =    -8.41651963206692 * H11 ;
...
END;
*** *****************************;
*** Writing the Residuals  of the Node WidgBuy ;
*** ******************************;
IF MISSING( WidgBuyYes ) THEN R_WidgBuyYes  = . ;
ELSE R_WidgBuyYes  = WidgBuyYes  - P_WidgBuyYes ;
IF MISSING( WidgBuyNo ) THEN R_WidgBuyNo  = . ;
ELSE R_WidgBuyNo  = WidgBuyNo  - P_WidgBuyNo ;
*** *************************;
